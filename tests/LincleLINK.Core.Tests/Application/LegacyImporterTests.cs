...
public sealed class LegacyImporterTests : IDisposable
{
    ...
    public LegacyImporterTests()
    {
        ...
        _importer = new LegacyImporter(_repository);
    }
    ...
    {
        var xmlPath = _temp.CreateFile("DBInfo.xml", System.Text.Encoding.UTF8.GetBytes(TestData.V1DbInfoXml));
        ...
        imported!.Name.Should().Be("IIDX28");
